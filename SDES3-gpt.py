...
def main():
    def encrypt_text():
        ...
        if not validate_binary(key):
            messagebox.showerror("Input Error", "Key should be a binary string of length 10.")
            return
        ...
        messagebox.showinfo("Encryption", "Text encrypted successfully with the given key.")
    ...
    def decrypt_text():
        ...
        messagebox.showinfo("Decryption", "Text decrypted successfully with the given key.")
